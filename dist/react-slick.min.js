          ...
          C = function(e) {
            ...
            if (
              (a
                ...
                : (c % d != 0 && c < i + d && (m = u - (c % d)),
                  l && (m = parseInt(u / 2))),
              (t = l && -1 === Math.sign(g) ? m * p - Math.abs(g) : m * p),
              (n = b ? i * y * -1 + m * y : i * p * -1 + t),
              !0 === h)
            ) {
              var w,
                O = s.a.findDOMNode(o);
              if (
                ((w = i + z(e)),
                (n = (r = O && O.childNodes[w]) ? -1 * r.offsetLeft : 0),
                !0 === l)
              ) {
                (w = a ? i + z(e) : i), (r = O && O.children[w]);
                for (var k = (n = 0); k < w; k++)
                  n -= O && O.children[k] && O.children[k].offsetWidth;
                      ...
                      return (
                        i.a.Children.forEach(e.children, function(c, u) {
                          ...
                          if (
                            ...
                            e.infinite && !1 === e.fade && s > e.slidesToShow)
                          ) {
                            var b = s - u;
                            b <= z(e) &&
                              s !== e.slidesToShow &&

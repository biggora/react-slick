...
var getTrackCSS = function getTrackCSS(spec) {
  ...
  if (!spec.vertical) {
    trackWidth = spec.slideCount > spec.slidesToShow ? getTotalSlides(spec) * spec.slideWidth : spec.listWidth;
  } else {
...
var getTrackLeft = function getTrackLeft(spec) {
  ...
  var parsedCenterPadding = parseInt(spec.centerPadding);
  ...
  slideOffset = centerMode && Math.sign(parsedCenterPadding) === -1 ? slidesToOffset * slideWidth - Math.abs(parsedCenterPadding) : slidesToOffset * slideWidth;
